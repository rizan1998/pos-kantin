...
$route['stock-opname-category-detail/(:any)/(:any)'] = 'administrator/stock_opname/stockopname_category_detail/$1/$2';
$route['stock-opname-cetak/(:any)/(:any)'] = 'administrator/stock_opname/cetak_hasil_so/$1/$2';
