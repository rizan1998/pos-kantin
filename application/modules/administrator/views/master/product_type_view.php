    ...
    <script>
        ...
        $(document).ready(function(){
            table=$('#data-datatable').DataTable({
                ...
                "order": [], 
                "ajax": {
                    "url": "<?php echo base_url(); ?>administrator/product/ajx_data_product_type/",
                    "type": "POST"
                },
            ...
            $("#basic-form").submit(function(){
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url(); ?>administrator/product/type_process",
                    data: data_val,
            ...
            $('#data-datatable').on('click', '#edit', function () {
                ...
                $.get("<?php echo base_url(); ?>administrator/product/get_where_type/"+id, function(data){
            ...
            $('#data-datatable').on('click', '#delete', function () {
                ...
                swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.get("<?php echo base_url(); ?>administrator/product/type_delete/"+id, function(data){
                            var req=JSON.parse(data);
                            if(req.info=="yes"){
                                table.ajax.reload(); 
