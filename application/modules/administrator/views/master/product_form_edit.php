                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" readonly name="code" id="code" value="<?php echo $items['code'] ?>" readonly>
                                </div>
                            </div>
                            <div class="col-lg-12 col-md-12">
                                <div class="form-group">
                                    <label>Barcode</label>
                                    <input type="text" class="form-control" name="barcode" id="barcode" value="<?php echo $items['barcode']?>">
                            ...
                            <div class="col-lg-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="name" id="name" value="<?php echo $items['name']?>">
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="category_id" id="category_id" class="form-control">
                                        ...
                                        <?php foreach ($category as $c): ?>
                                            <option value="<?php echo $c['inc_id']?>" <?php if($items['category_id']==$c['inc_id']) echo "selected" ?>><?php echo $c['name']?></option>
                                        <?php endforeach ?>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="type_id" id="type_id" class="form-control">
                                        ...
                                        <?php foreach ($type as $t): ?>
                                            <option value="<?php echo $t['inc_id']?>" <?php if($items['type_id']==$t['inc_id']) echo "selected" ?>><?php echo $t['name']?></option>
                                        <?php endforeach?>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="unit_id" id="unit_id" class="form-control">
                                        ...
                                        <?php foreach ($unit as $u): ?>
                                            <option value="<?php echo $u['inc_id']?>" <?php if($items['unit_id']==$u['inc_id']) echo "selected" ?>><?php echo $u['name']?></option>
                                        <?php endforeach ?>
                                    </select>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"  name="min_stok" id="min_stok" value="<?php echo $items['min_stok']?>">
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-12">
                                <div class="form-group">
                                    <label>Harga Beli</label>
                                    <input type="text" class="form-control"  name="price" id="price" onkeyup="func_price_ppn()"  value="<?php echo $items['price']?>">
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-12">
                                <div class="form-group">
                                    <label>PPn (%)</label>
                                    <input type="number" class="form-control"   name="ppn" id="ppn" value="11"  onkeyup="func_price_ppn()"  value="<?php echo $items['ppn']?>">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" readonly  name="price_ppn" id="price_ppn"  value="<?php echo $items['price_ppn']?>">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12 col-md-12">
                                <div class="form-group">
                                    <label>Promo</label>
                                    <input type="text" class="form-control"  name="promo" id="promo" value="<?php echo $items['promo']?>">
                                </div>
                            </div>
                            <br>
                            <div class="col-lg-12 col-md-12">
