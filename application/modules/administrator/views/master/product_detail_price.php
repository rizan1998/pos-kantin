                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body"> 
                                                                ...
                                                                <div class="form-group">
                                                                    <label>Jenis Harga</label>
                                                                    <select name="type_price" id="type_price" class="form-control">
                                                                        <option value="1" <?php if($type_price==1) echo 'selected'; else echo ''; ?>>Harga Retail</option>
                                                                        <option value="2" <?php if($type_price==2) echo 'selected'; else echo ''; ?>>Harga Distributor</option>
                                                                        <option value="3" <?php if($type_price==2) echo 'selected'; else echo ''; ?>>Harga Online</option>
                                                                    </select>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label>Satuan Barang</label>
                                                                    <select name="unit_id" id="unit_id" class="form-control">
                                                                        <option value="">-</option>
                                                                        <?php foreach ($unit as $u): ?>
                                                                            <option value="<?php echo $u['inc_id']?>" <?php if($is['unit_id']==$u['inc_id']) echo 'selected'; echo ''?>><?php echo $u['name']?></option>;
                                                                        <?php endforeach ?>
                                                                    </select>
                                                                </div>
                                                                <div class="form-group">
