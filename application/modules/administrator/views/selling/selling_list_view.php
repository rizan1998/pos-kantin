            ...
            <div class="card planned_task">
                <div class="header">
                    ...
                    <div class="col-lg-6 hidden-sm text-right">
                        <button type="button" class="btn btn-outline-info" data-target="#modal-print" data-toggle="modal"><i class="fa fa-print"></i> Cetak <?php echo $subpage ?></button>
                    </div>
                    <?php endif ?>
                    </div>
                </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Cetak Data <?php echo $subpage ?></h5>
