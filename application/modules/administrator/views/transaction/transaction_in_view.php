                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" data-provide="datepicker" data-date-autoclose="true" class="form-control" id="date-in" name="date_in" value="<?php echo date('d/m/Y') ?>">
                                </div>
                            </div>
...
<script>
    function savetransin() {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>administrator/transaction/transaction_in_add/",
            data: datas,
    ...
    $(document).ready(function() {
        ...
        table = $('#data-datatable').DataTable({
            ...
            "order": [],
            "ajax": {
                "url": "<?php echo base_url(); ?>administrator/transaction/ajx_data_transaction_in/",
                "type": "POST",
                "data": function(data) {
        ...
        $('#data-datatable').on('click', '#trans', function() {
            ...
            window.location.href = "<?php echo base_url() ?>transaction-form/" + id;
            // alert(id);
        });

        $('#data-datatable').on('click', '#details', function() {
            var id = $(this).attr('idatr');
            window.location.href = "<?php echo base_url() ?>transaction-indetail/" + id;
            // alert(id);
        });
        ...
        $('#data-datatable').on('click', '#delete', function() {
            ...
            swal.fire({
                ...
                if (result.isConfirmed) {
                    $.get("<?php echo base_url(); ?>administrator/trans_in/cancel_trans_in/" + id, function(data) {
                        var req = JSON.parse(data);
                        if (req.info == "yes") {
                            table.ajax.reload();
