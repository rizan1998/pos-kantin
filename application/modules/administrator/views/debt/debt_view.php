...
<?php $this->load->view('parts/main_part'); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="employee" name="employee" placeholder="nama lengkap">
                            </div>
                        </div>
                        <div class="col-lg-2 col-md-12">
                            <label for="">&nbsp;</label>
                ...
                <div class="header">
                    <div class="row">
                        ...
                        <div class="col-lg-6 hidden-sm text-right">
                            <button type="button" class="btn btn-outline-info" data-target="#modal-print-debt" data-toggle="modal"><i class="fa fa-print"></i> Cetak Hutang</button>
                        </div>
                        <?php endif ?>
                    </div>
                </div>
    ...
    <!-- Modal -->
    <div class="modal fade" id="modal-print-debt" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Cetak Data Hutang</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="">Karyawan <sup style="color: red">wajib isi</sup></label>
                        <input type="text" class="form-control" id="employee-print" name="employee-print" placeholder="nama lengkap" required>
                    </div>
                    
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Tutup</button>
                    <button type="button" class="btn btn-primary" id="btn-print-debt">Cari Data</button>
                </div>
            </div>
        </div>
    </div>
...
?>
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#start-date-print').datepicker({
			    format: 'dd/mm/yyyy'
			});

			$('#end-date-print').datepicker({
			    format: 'dd/mm/yyyy'
			});	
            ...
            table=$('#data-datatable').DataTable({
                ...
                "order": [], 
                "ajax": {
                    "url": "<?php echo base_url(); ?>administrator/debt/ajx_data_debt/",
                    "type": "POST",
                    "data": function ( data ) {
            ...
            $('#data-datatable').on('click', '#next', function () {
                var id=$(this).attr('idatr');
            ...
            $("#btn-print-debt").click(function(){
                ...
                console.log(data)
                window.open("<?php echo base_url(); ?>administrator/debt/print_debt/"+tanggal_awal+"/"+tanggal_akhir+"/"+data.status+"/"+data.employee+"/"+id, "_blank")
            })
