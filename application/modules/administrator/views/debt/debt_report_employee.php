...
<body oncontextmenu="return false">
  ...
  <div id="printArea" >
    ...
    <h4 style="text-align: center;">LAPORAN UTANG <?php echo strtoupper($debt['employee'])?></h4>
    ...
    <table width="100%" border="1" id="item">
        <thead>
            <tr>
                ...
                <th style="text-align: center">Total Utang</th>
            ...
            <?php 
                ...
                foreach($list as $l){
                    ...
                    echo '<tr>
                        ...
                        <td style="text-align: right">'.curr_format($l['debt_total']).'</td>
                        <td style="text-align: center">'.$status.'</td>
                    </tr>';
                    $totalutang += $l['debt_total'];
                }
            ?>

            <tr>
                <th colspan="3" style="text-align: right">TOTAL UTANG</th>
                <th style="text-align: right"><?php echo curr_format($totalutang) ?></th>
                <td></td>
            </tr>
        </tbody>
    </table>
