<?php
    ...
    class Stockopname_Model extends CI_Model {
        ...
        var $table = 'stockopname s';
        var $column_order = array('code_in', 'date_stockopname', 'status');
        var $column_search = array('code_in', 'date_stockopname', 'status');
        var $order = array('date_stockopname'=>'desc');
